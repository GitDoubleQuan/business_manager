...
public class JedisPoolUtils {
	...
	static {
		...
		String ip = MyPropertiesUtil.getMyProperty("redis.properties", "redis.ip");
		String port = MyPropertiesUtil.getMyProperty("redis.properties", "redis.port");

		jedisPool = new JedisPool(c, ip, Integer.valueOf(port)); // 初始化连接池
	}
