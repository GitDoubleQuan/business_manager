    ...
    <script type="text/javascript">
        ...
        function get_tm_sku(class_1_id){
            ...
            $.getJSON("js/json/tm_class_1_"+class_1_id+".js",function(data){
                // 用js循环json的分类集合
                $("#tm_select_attr").empty();
                $(data).each(function(i,json){
                    // 将分类集合的内容生成<option>对象加载到下拉列表中
                    $("#tm_select_attr").append("<option value="+json.id+">"+json.ppmch+"</option>");
                });
            });
        }
        ...
        function get_attr_by_class_2_sku(class_2_id){
            ...
            $.post("get_attr_by_class_2_sku.do",{class_2_id:class_2_id},function(data){
                $("#manager_sku_list_inner").html(data);
            });
...
<body>
<select name="flbh1" id="class_1_select_attr" onchange="get_class_2_sku(this.value)">
    <option>请选择</option>
</select>
<select name="flbh2" id="class_2_select_attr" onchange="get_attr_by_class_2_sku(this.value)">
    <option>请选择</option>
</select>
</body>
</html>